setwd("~/Downloads/Amazon_work/Amaggle/CIKMAnalyticCup/code/")
library(Rmisc)
library(data.table)
library(stringr)
library(ggplot2)
...
source("o01_create_dataset_v2.R")
...
# 0.2150666, 0.2147435, 0.2117275 0.2166548 0.2124151 0.2112836
pred_train3_con = predict(xgb_con, train3_x_con)
rmse(pred_train3_con, train3_y_con)
# 0.4218802, 0.4208466, 0.3809649 0.3774201 0.3793716 0.3567688
